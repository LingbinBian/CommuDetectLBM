...
% group-level analysis using majority voting
%
% Version 1.0 
...
load(['Results/synthetic_LBM','/DIIV',num2str(DIIV),'/n',num2str(n_s),'/grouplevel_results_majorityvote.mat']);
...
NMI_path=fullfile(data_path,['Results/synthetic_LBM','/DIIV',num2str(DIIV),'/n',num2str(n_s),'/NMI_majorityvote']);
save(NMI_path,'NMI')

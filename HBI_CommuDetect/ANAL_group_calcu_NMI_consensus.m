...
% group-level analysis using consensus clustering
%
% Version 1.0 
...
load(['Results/synthetic_LBM','/DIIV',num2str(DIIV),'/n',num2str(n_s),'/grouplevel_results_',num2str(N_simu),'_consensus','.mat']);
...
NMI_path=fullfile(data_path,['Results/synthetic_LBM','/DIIV',num2str(DIIV),'/n',num2str(n_s),'/NMI_consensus_',num2str(N_simu)]);
save(NMI_path,'NMI')

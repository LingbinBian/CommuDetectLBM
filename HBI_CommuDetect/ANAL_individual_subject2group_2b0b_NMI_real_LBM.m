...
results_path=fullfile(data_path,'Results/real_LBM/LR/subject2group_2b0b');
save(results_path); 
saveas(gcf,'Results/real_LBM/LR/subject2group_2b0b.fig')
saveas(gcf,'Results/real_LBM/LR/subject2group_2b0b.svg')
% -------------------------------------------------------------------------
% sigline

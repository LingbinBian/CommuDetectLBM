...
for s=1:N_state
   ...
   label_group_esti(:,s)=CommuDetecMajorityVote(mat_labels);
...
if datatype==0    
    for t=1:N_state
        ...
        saveas(gcf,['Results/synthetic_LBM/','DIIV',num2str(DIIV),'/n',num2str(n_s),'/Labels_esti_majorityvote_',num2str(t),'.fig'])
    ...
    for t=1:N_state
        ...
        set(gcf,'unit','normalized','position',[0.3,0.2,0.08,0.33]);
        saveas(gcf,['Results/synthetic_LBM/','DIIV',num2str(DIIV),'/n',num2str(n_s),'/Labels_switched_majorityvote_',num2str(t),'.fig'])
    end
    ...
    for t=1:N_state
        ...
        saveas(gcf,['Results/synthetic_LBM/','DIIV',num2str(DIIV),'/n',num2str(n_s),'/Labels_true_majorityvote_',num2str(t),'.fig'])
    end
end
...
if datatype==1  
    for t=1:N_state
        ...
        set(gcf,'unit','normalized','position',[0.3,0.2,0.08,0.33]);
        if session_n==1
            saveas(gcf,['Results/real/LR/','Label_est_majorityvote_',num2str(t),'.fig'])
        elseif session_n==2
            saveas(gcf,['Results/real/RL/','Label_esti_majorityvote_',num2str(t),'.fig'])
        end
...
if datatype==0
   group_results_path=fullfile(data_path,['Results/synthetic_LBM/','DIIV',num2str(DIIV),'/n',num2str(n_s),'/grouplevel_results_majorityvote']);
   save(group_results_path);
elseif datatype==1
   if session_n==1
       group_results_path=fullfile(data_path,['Results/real/LR/','grouplevel_results_majorityvote']);
   elseif session_n==2
       group_results_path=fullfile(data_path,['Results/real/RL/','grouplevel_results_majorityvote']);
   end

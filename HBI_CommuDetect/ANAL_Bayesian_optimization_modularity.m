...
function []=opt_parameter(group_adj,true_latent_sub,n_s,N_subj,atlas,vari,state)  
    ...
    NMI_indi_path=fullfile(['/home/bianlb/Documents/CommuDetectLBM/HBI_CommuDetect/Results/synthetic_Bayes_opt_M','/','DIIV',num2str(vari),'/n',num2str(n_s),'/opt_para_',num2str(state)]);
